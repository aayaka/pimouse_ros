...
class LightsensorTest(unittest.TestCase):
	...
	def check_values(self, lf, ls, rs, rf):
		vs = self.values
		self.assertEqual(vs.lest_forward, lf, "different value: left_forward")
		self.assertEqual(vs.lest_side, ls, "different value: left_side")
